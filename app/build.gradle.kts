...
android {
    namespace = "com.mohamadrizki.pokemondatabase"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.mohamadrizki.pokemondatabase"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.activity:activity-ktx:1.6.1") //lifecycleScope
